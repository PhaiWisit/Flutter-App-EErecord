...
import 'package:village_visitor/model/LicensePlateModel.dart';
...
class _DisplayPictureScreenState extends State<DisplayPictureScreen> {
  ...
  void cropImage() {
    final image = ImageC.decodeImage(File(widget.imagePath).readAsBytesSync())!;
    final thumbnail = ImageC.copyCrop(image, 60, 240, 360, 240);
    File(widget.imagePath).writeAsBytesSync(ImageC.encodePng(thumbnail));
  }

  Future<LicensePlateModel> getLicensePlateData() async {
    var postUri = Uri.parse("https://api.aiforthai.in.th/panyapradit-lpr");
